...
<div id="primary" class="content-area row">
	...
	?>
		<aside id="<?php echo esc_attr($wpbs['sidebar']); ?>" class="secondary widget-area col-12 col-sm-4 col-md-3" role="complementary" aria-label="<?php esc_attr_e('Sidebar', I18N_TEXTDOMAIN); ?>">
